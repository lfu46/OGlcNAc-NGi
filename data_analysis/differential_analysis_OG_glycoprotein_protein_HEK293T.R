...
#generate data frame
OG_glycoprotein_protein_OGlcNAc_effect_HEK293T <- OG_glycoprotein_raw_sl_tmm_HEK293T |> 
...
data_matrix <- data.matrix(OG_glycoprotein_protein_OGlcNAc_effect_HEK293T |> select(starts_with("log2")))
rownames(data_matrix) <- OG_glycoprotein_protein_OGlcNAc_effect_HEK293T$UniprotID
...
top_tb$UniprotID <- rownames_HEK293T

OG_glycoprotein_protein_OGlcNAc_effect_Top_tb_HEK293T <- top_tb

write_xlsx(OG_glycoprotein_protein_OGlcNAc_effect_Top_tb_HEK293T, path = paste0(file_path, "OG_glycoprotein_protein_OGlcNAc_effect_Top_tb_HEK293T.xlsx"))
