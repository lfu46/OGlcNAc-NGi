...
#wilcox test
OG_glycoprotein_transcription_factor_logFC_wilcox_test <- 
  OG_glycoprotein_transcription_factor_logFC_total |> 
  group_by(Cell) |> 
  wilcox_test(logFC ~ Group, p.adjust.method = "BH") |> 
  add_significance("p")

#ks test
OG_glycoprotein_transcription_factor_logFC_ks_test <- 
  OG_glycoprotein_transcription_factor_logFC_wilcox_test |> 
...
point_plot_OG_glycoprotein_transcription_factor_logFC_total <- OG_glycoprotein_transcription_factor_logFC_total |> 
  ...
  stat_pvalue_manual(data = OG_glycoprotein_transcription_factor_logFC_ks_test, label = "p.signif", 
                     tip.length = 0, size = 50, hide.ns = "p",
                     y.position = c(1.8)) +
